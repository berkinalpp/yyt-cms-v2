  ...
  for (let i = 1; i <= fieldCount; i++) {
    ...
    fields.push(
      ...
      <div>
        ...
        <form class="form" >
          <input id={i} type="text" class="form__field" placeholder="Field Name" />
        </form>
      </div>
        {types.map(
          (
  ...
  return (
    ...
    <main>
      ...
      <div class="container__item">
          ...
          <input type="text" class="form__field" placeholder="Content Type Name" id="contentType"/>
      ...
      <button  id="preview" onClick={addField} class="btn btn--primary uppercase">
        Add new field
      </button>
      <button id="preview" onClick={previewTable} class="btn btn--primary btn--inside uppercase">Preview</button>
